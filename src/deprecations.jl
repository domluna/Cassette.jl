function Sorry_OverdubInstead_Is_Deprecated()
    return error("Usage of `OverdubInstead` should be replaced by `Cassette.recurse`; see `Cassette.recurse` for details.")
end
