...
makedocs(modules=[Cassette], doctest=false, format=:html, sitename="Cassette",
         pages=["Introduction" => "index.md", "Disclaimers" => "disclaimers.md",
...
deploydocs(repo="github.com/jrevels/Cassette.jl.git", osname="linux", julia="1.0",
